...
if road == "left":
    lake = input('You\'ve come to the lake there is an island in the middle of the lake. Type "wait" to wait for a boat or "swim" to swim across.\n').lower()
    if lake == "wait":
        ...
        if door == "yellow":
            ...
            print("You enter a roam of beasts. Game Over!")
        else:
